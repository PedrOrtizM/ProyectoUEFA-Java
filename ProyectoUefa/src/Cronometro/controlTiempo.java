...
public class controlTiempo {
  ...
  for(;;){
                    ...
                    try {
                        ...
                        Logger.getLogger(Vista.SimulacionPartido.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
      ...
      this.hiloCronometro = new Thread(){
            ...
            public void run(){
                for(;;){ // for infinito para que corra hasta que se explote la memoria ram
                    ...
                    if (cronometro.getSegundos() == 10) {//si los segundos son iguales a 59
                    ...
                    if (cronometro.getMinutos() == 10) {//si los minutos son iguales a 59
                    ...
                    if(cronometro.getHoras()==45 && ax==false){   
                     JLtiempo.setText("Primer Tiempo");
                        try {
                            Thread.sleep(6000);
                        } catch (InterruptedException ex) {
                   ...
                   if(cronometro.getHoras()==90 && ax==true){   
                     JLtiempo.setText("  Fin Partido");
                        try {
                            Thread.sleep(4000);
                        } catch (InterruptedException ex) {
                            Logger.getLogger(controlTiempo.class.getName()).log(Level.SEVERE, null, ex);
                   ...
                   hiloHora.stop();
                    ...
                    JLtiempo.setText(""+cronometro.getHoras()+" : "+cronometro.getMinutos());
